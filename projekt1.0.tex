...
\documentclass[10pt,twoside,twocollum,slovak,a4paper]{article}
...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=1.0]{diagram2.png}
\caption{ Web User Diagram}
\label{f:rozhod}
\end{figure*}
...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=1.0]{FIIT.png}
\caption{FIIT}
\label{f:rozhod}
\end{figure*}
